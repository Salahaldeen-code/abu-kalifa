...
export default function ServicesPage() {
  return (
    <>
      ...
      <Hero
        title="خدماتنا"
        description="في أبو خليفة العالمية للسفر والسياحة نقدم مجموعة متكاملة من خدمات التأشيرات والسفر، للأفراد والشركات، مع متابعة دقيقة والتزام بالأنظمة الرسمية."
      />
      {/* About Section */}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center">
              نقدم في أبو خليفة العالمية للسفر والسياحة مجموعة متكاملة من الخدمات
