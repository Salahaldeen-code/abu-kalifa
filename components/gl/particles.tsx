...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    // Calculate reveal progress - start fully revealed for white background
    ...
    // Start fully revealed immediately (set to max value)
    const revealFactor = 4.0; // Always fully revealed
