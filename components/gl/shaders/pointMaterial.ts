  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        // Calculate sparkle brightness multiplier (only for alpha, not color)
        ...
        // Color: #458A47 - applied directly to wave particles themselves (NO OVERLAY)
        // RGB values: R=69/255=0.270588, G=138/255=0.541176, B=71/255=0.278431
        // This is the actual particle color, not an overlay
        vec3 particleColor = vec3(0.27058823529411763, 0.5411764705882353, 0.2784313725490196);
        
        // Directly apply green color to particles - NO color modifications
        // Only alpha channel varies for transparency effects
        float finalAlpha = mix(alpha, sparkleBrightness - 1.1, uTransition);
        
        // Output: Pure green color (#458A47) - RGB values directly from hex color
        // No brightness adjustments, no overlays, no blending modifications
